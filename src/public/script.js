...
$(document).ready(function(){
  ...
  function startJoinCall(user_id) { 
     socket.emit('get_user_in_room', user_id, roomId)
  }
  ...
  socket.on('receive_user_in_room',  async (clients) => {
    ...
    if(clients[user_id] != undefined) {
      console.log("================ clients[user_id] != undefined ...=================")
      console.log(clients)
      debugger;
  ...
  return new Promise(async (resolve, reject) => {
    try {
      call.on('stream',async function(remoteStream){
        ...
        console.log(`================  RUN ONE TIME ${user_id}  Globalclients=================`)
        console.log(Globalclients)
        console.log(`================  RUN ONE TIME ${user_id}  clientData=================`)
